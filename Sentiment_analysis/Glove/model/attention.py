...
class AttentionLSTM_Multiplicative(nn.Module):
    ...
    def __init__(self, text_field, label_field, n_embed, hidden_node, hidden_node_decode, n_output, layers):
        super().__init__()
...
class AttentionLSTM_Additive(nn.Module):
    ...
    def __init__(self, text_field, label_field, n_embed, hidden_node, hidden_node_decode, n_output, layers, v_attention_dimensionality):
        super().__init__()
